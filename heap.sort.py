...
def heapify(array, n, i):
    ...
    if ramaIzq < n and array[ramaIzq] > array[raiz]:
        raiz = ramaIzq

    if ramaDer < n and array[ramaDer] > array[raiz]:
        raiz = ramaDer

    if raiz != i:
        array[i], array[raiz] = array[raiz], array[i]
        heapify(array, n, raiz)
...
heap_sort(array)
#print("\nLa array ordenada es: ",array,"\n")

fin = time.time()
tiempo = fin - inicio
tiempo_formateado = "{:.3f}".format(tiempo)
tiempo_heapsort.append(tiempo_formateado)
...
tiempo_heapsort.append(tiempo_formateado2)
...
tiempo_heapsort.append(tiempo_formateado3)
...
tiempo_heapsort.append(tiempo_formateado4)
...
tiempo_heapsort.append(tiempo_formateado5)
...
tiempo_heapsort.append(tiempo_formateado6)
...
tiempo_heapsort.append(tiempo_formateado7)
...
tiempo_heapsort.append(tiempo_formateado8)
...
tiempo_heapsort.append(tiempo_formateado9)
...
tiempo_heapsort.append(tiempo_formateado10)
...
tiempo_heapsort.append(tiempo_formateado11)
...
tiempo_heapsort.append(tiempo_formateado12)
...
tiempo_heapsort.append(tiempo_formateado13)
...
tiempo_heapsort.append(tiempo_formateado14)
...
tiempo_heapsort.append(tiempo_formateado15)
...
tiempo_heapsort.append(tiempo_formateado16)
...
tiempo_heapsort.append(tiempo_formateado17)
...
tiempo_heapsort.append(tiempo_formateado18)
...
tiempo_heapsort.append(tiempo_formateado19)
...
tiempo_heapsort.append(tiempo_formateado20)
...
tiempo_heapsort.append(tiempo_formateado21)
print("Tiempo de ejecución:", tiempo_formateado21, "segundos\n")
##########################################################################

y2 = []
# Abre el archivo en modo lectura
with open('C:\\Users\\USUARIO\\OneDrive\\Escritorio\\codigos_c++\\lista_tiempos_heapsort.txt', 'r') as archivo:
...
y1 = [float(valor) for valor in tiempo_heapsort]
print("\n",y1,"\n")
...
# Título del gráfico
ax.set_title('Tiempo de Ejecución - HEAP SORT')
