...
def counting_sort(array):
    ...
    aux = [0] * (valor_maximo - valor_minimo + 1)
    aux_ordenada = [0] * len(array)

    for num in array:
        aux[num - valor_minimo] += 1

    for i in range(1, len(aux)):
        aux[i] += aux[i - 1]

    for num in reversed(array):
        aux_ordenada[aux[num - valor_minimo] - 1] = num
        aux[num - valor_minimo] -= 1

    return aux_ordenada

#print("\nLista original: ", lista)
lista_ordenada = counting_sort(array)
#print("\nLista ordenada: ", lista_ordenada, "\n")

fin = time.time()
tiempo = fin - inicio
tiempo_formateado = "{:.3f}".format(tiempo)
tiempo_countingsort.append(tiempo_formateado)
...
tiempo_countingsort.append(tiempo_formateado2)
...
tiempo_countingsort.append(tiempo_formateado3)
...
tiempo_countingsort.append(tiempo_formateado4)
...
tiempo_countingsort.append(tiempo_formateado5)
...
tiempo_countingsort.append(tiempo_formateado6)
...
tiempo_countingsort.append(tiempo_formateado7)
...
tiempo_countingsort.append(tiempo_formateado8)
...
tiempo_countingsort.append(tiempo_formateado9)
...
tiempo_countingsort.append(tiempo_formateado10)
...
tiempo_countingsort.append(tiempo_formateado11)
...
tiempo_countingsort.append(tiempo_formateado12)
...
tiempo_countingsort.append(tiempo_formateado13)
...
tiempo_countingsort.append(tiempo_formateado14)
...
tiempo_countingsort.append(tiempo_formateado15)
...
tiempo_countingsort.append(tiempo_formateado16)
...
tiempo_countingsort.append(tiempo_formateado17)
...
tiempo_countingsort.append(tiempo_formateado18)
...
tiempo_countingsort.append(tiempo_formateado19)
...
tiempo_countingsort.append(tiempo_formateado20)
...
tiempo_countingsort.append(tiempo_formateado21)
print("Tiempo de ejecución:", tiempo_formateado21, "segundos\n")
##########################################################################

y2 = []
# Abre el archivo en modo lectura
with open('C:\\Users\\USUARIO\\OneDrive\\Escritorio\\codigos_c++\\lista_tiempos_countingsort.txt', 'r') as archivo:
...
y1 = [float(valor) for valor in tiempo_countingsort]
print("\n",y1,"\n")
...
# Título del gráfico
ax.set_title('Tiempo de Ejecución - COUNTING SORT')
