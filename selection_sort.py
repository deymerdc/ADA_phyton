...
#print("\nLista sin ordenar: ", array, "\n")

fin = time.time()
tiempo = fin - inicio
tiempo_formateado = "{:.3f}".format(tiempo)
timepo_selectionsort.append(tiempo_formateado)
print("\nTiempo de ejecución:", tiempo_formateado, "segundos\n")
##########################################################################
inicio2 = time.time()
...
timepo_selectionsort.append(tiempo_formateado2)
...
timepo_selectionsort.append(tiempo_formateado3)
...
timepo_selectionsort.append(tiempo_formateado4)
...
timepo_selectionsort.append(tiempo_formateado5)
...
timepo_selectionsort.append(tiempo_formateado6)
...
timepo_selectionsort.append(tiempo_formateado7)
...
timepo_selectionsort.append(tiempo_formateado8)
...
timepo_selectionsort.append(tiempo_formateado9)
...
timepo_selectionsort.append(tiempo_formateado10)
...
timepo_selectionsort.append(tiempo_formateado11)
...
timepo_selectionsort.append(tiempo_formateado12)
...
timepo_selectionsort.append(tiempo_formateado13)
...
timepo_selectionsort.append(tiempo_formateado14)
...
timepo_selectionsort.append(tiempo_formateado15)
...
timepo_selectionsort.append(tiempo_formateado16)
...
timepo_selectionsort.append(tiempo_formateado17)
...
timepo_selectionsort.append(tiempo_formateado18)
...
timepo_selectionsort.append(tiempo_formateado19)
...
timepo_selectionsort.append(tiempo_formateado20)
...
timepo_selectionsort.append(tiempo_formateado21)
print("Tiempo de ejecución:", tiempo_formateado21, "segundos\n")
##########################################################################

y2 = []
# Abre el archivo en modo lectura
with open('C:\\Users\\USUARIO\\OneDrive\\Escritorio\\codigos_c++\\lista_tiempos_selectionsort.txt', 'r') as archivo:
...
y1 = [float(valor) for valor in timepo_selectionsort]
print("\n",y1,"\n")
...
# Título del gráfico
ax.set_title('Tiempo de Ejecución - SELECTION SORT')
