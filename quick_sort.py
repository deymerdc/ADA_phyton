...
quicksort(array)
#print("\nLista sin ordenar: ",lista_ordenada,"\n")

fin = time.time()
tiempo = fin - inicio
tiempo_formateado = "{:.3f}".format(tiempo)
tiempo_quicksort.append(tiempo_formateado)
...
tiempo_quicksort.append(tiempo_formateado2)
...
tiempo_quicksort.append(tiempo_formateado3)
...
tiempo_quicksort.append(tiempo_formateado4)
...
tiempo_quicksort.append(tiempo_formateado5)
...
tiempo_quicksort.append(tiempo_formateado6)
...
tiempo_quicksort.append(tiempo_formateado7)
...
tiempo_quicksort.append(tiempo_formateado8)
...
tiempo_quicksort.append(tiempo_formateado9)
...
tiempo_quicksort.append(tiempo_formateado10)
...
tiempo_quicksort.append(tiempo_formateado11)
...
tiempo_quicksort.append(tiempo_formateado12)
...
tiempo_quicksort.append(tiempo_formateado13)
...
tiempo_quicksort.append(tiempo_formateado14)
...
tiempo_quicksort.append(tiempo_formateado15)
...
tiempo_quicksort.append(tiempo_formateado16)
...
tiempo_quicksort.append(tiempo_formateado17)
...
tiempo_quicksort.append(tiempo_formateado18)
...
tiempo_quicksort.append(tiempo_formateado19)
...
tiempo_quicksort.append(tiempo_formateado20)
...
tiempo_quicksort.append(tiempo_formateado21)
...
with open('C:\\Users\\USUARIO\\OneDrive\\Escritorio\\codigos_c++\\lista_tiempos_quicksort.txt', 'r') as archivo:
...
y1 = [float(valor) for valor in tiempo_quicksort]
print("\n",y1,"\n")
...
# Título del gráfico
ax.set_title('Tiempo de Ejecución - QUICK SORT')
