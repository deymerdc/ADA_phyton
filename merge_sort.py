...
#print("\nLista Ordenada:", array_ordenado)

fin = time.time()
tiempo = fin - inicio
tiempo_formateado = "{:.3f}".format(tiempo)
tiempo_mergesort.append(tiempo_formateado)
...
tiempo_mergesort.append(tiempo_formateado2)
...
tiempo_mergesort.append(tiempo_formateado3)
...
tiempo_mergesort.append(tiempo_formateado4)
...
tiempo_mergesort.append(tiempo_formateado5)
...
tiempo_mergesort.append(tiempo_formateado6)
...
tiempo_mergesort.append(tiempo_formateado7)
...
tiempo_mergesort.append(tiempo_formateado8)
...
tiempo_mergesort.append(tiempo_formateado9)
...
tiempo_mergesort.append(tiempo_formateado10)
...
tiempo_mergesort.append(tiempo_formateado11)
...
tiempo_mergesort.append(tiempo_formateado12)
...
tiempo_mergesort.append(tiempo_formateado13)
...
tiempo_mergesort.append(tiempo_formateado14)
...
tiempo_mergesort.append(tiempo_formateado15)
...
tiempo_mergesort.append(tiempo_formateado16)
...
tiempo_mergesort.append(tiempo_formateado17)
...
tiempo_mergesort.append(tiempo_formateado18)
...
tiempo_mergesort.append(tiempo_formateado19)
...
tiempo_mergesort.append(tiempo_formateado20)
...
tiempo_mergesort.append(tiempo_formateado21)
print("Tiempo de ejecución:", tiempo_formateado21, "segundos\n")
##########################################################################

y2 = []
# Abre el archivo en modo lectura
with open('C:\\Users\\USUARIO\\OneDrive\\Escritorio\\codigos_c++\\lista_tiempos_mergesort.txt', 'r') as archivo:
...
y1 = [float(valor) for valor in tiempo_mergesort]
print("\n",y1,"\n")
...
# Título del gráfico
ax.set_title('Tiempo de Ejecución - MERGE SORT')
